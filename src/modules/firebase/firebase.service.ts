...
export class FirebaseService {
  ...
  constructor() {
    const credential = {
      ...
      client_email:
        'firebase-adminsdk-dwis8@togetherlist-e8f05.iam.gserviceaccount.com',
      client_id: '103692109602287899281',
      auth_uri: 'https://accounts.google.com/o/oauth2/auth',
      token_uri: 'https://oauth2.googleapis.com/token',
      auth_provider_x509_cert_url: 'https://www.googleapis.com/oauth2/v1/certs',
      client_x509_cert_url:
        'https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-dwis8%40togetherlist-e8f05.iam.gserviceaccount.com',
